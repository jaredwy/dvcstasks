...
[@ui.bambooSection titleKey='config.options']
    ...
    [#assign apiDescription]
        ...
        [/@ww.text]
    [/#assign]
    [@ww.checkbox id='acceptRemoteApiCalls_id' labelKey='config.options.api' description=apiDescription name="acceptRemoteApiCalls" value=acceptRemoteApiCalls helpUri="remote-api.ftl" /]
