...
<html>
<head>
    <title>[@ui.header pageKey='buildResult.testClass.title' object='${build.key}-${buildResultsSummary.buildNumber}
        ${testClassResult.shortName?html}' title=true/]
    </title>
...
<body>
    ...
    <p>
        ...
        build ${buildResultsSummary.buildNumber} of ${build.name}.
...
<div class="section">
    ...
    <table class="testResults aui" cellspacing="0" summary="Unit Test Results">
        ...
        [#list testClassResult.testCaseResults as testResult]
            ...
            [@ww.url id='testCaseUrl' value=fn.getTestCaseResultUrl(build.key, buildResults.buildNumber, testResult.testCase.id) /]
                ...
                <td>
                    [#if  testResult.failingSince > -1]
                         ...
                         [#if failingSinceBuild?has_content]
                            <a href="${req.contextPath}/browse/${build.key}-${failingSinceBuild.buildNumber}">${build.key}-${failingSinceBuild.buildNumber}</a>
                         [#else]
