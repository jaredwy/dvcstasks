...
<head>
    ...
    <meta name="topCrumb" content="admin">
    <meta name="adminCrumb" content="viewElasticInstanceSchedules">
</head>
<body>

<h1>[@ww.text name='elastic.schedule.list.title' /]</h1>

<p>
    [@ww.text name='elastic.schedule.list.description' /]
</p>

[@ui.clear /]
<div class="buttons">
    <a id="addElasticInstanceSchedule"
       href="${req.contextPath}/admin/elastic/schedule/addElasticInstanceSchedule.action"
       title="[@ww.text name='elastic.schedule.add.title' /]">[@ww.text name='elastic.schedule.add.title' /]</a>
    [#if elasticInstanceSchedules?has_content]
        |
        <a id="enableAllElasticInstanceSchedules"
           href="${req.contextPath}/admin/elastic/schedule/enableAllElasticInstanceSchedules.action"
           >[@ww.text name='global.buttons.enable.all' /]</a>
        |
        <a id="disableAllElasticInstanceSchedules"
           href="${req.contextPath}/admin/elastic/schedule/disableAllElasticInstanceSchedules.action"
           >[@ww.text name='global.buttons.disable.all' /]</a>
    [/#if]
</div>
[@ui.clear /]
