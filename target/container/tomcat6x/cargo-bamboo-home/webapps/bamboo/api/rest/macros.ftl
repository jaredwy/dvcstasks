[#macro buildResult buildSummary planManager]
    [#assign buildObject=planManager.getPlanByKey(buildSummary.getBuildKey()) /]
    <projectName>${buildObject.getProject().getName()}</projectName>
    <buildName>${buildObject.getBuildName()}</buildName>
    <buildKey>${buildSummary.buildKey!}</buildKey>
    <buildState>${buildSummary.buildState!}</buildState>
    <buildNumber>${buildSummary.buildNumber!}</buildNumber>
    <failedTestCount>${buildSummary.failedTestCount!}</failedTestCount>
    <successfulTestCount>${buildSummary.successfulTestCount!}</successfulTestCount>
