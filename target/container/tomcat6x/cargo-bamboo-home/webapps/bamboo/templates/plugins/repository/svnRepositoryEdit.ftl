...
[@ui.bambooSection titleKey='repository.advanced.option']
    [@ww.checkbox labelKey='repository.advanced.option.enable' toggle='true' name='temporary.svn.advanced' value='${repository.isAdvancedOptionEnabled(buildConfiguration)?string}' /]
    [@ui.bambooSection dependsOn='temporary.svn.advanced' showOn='true']
