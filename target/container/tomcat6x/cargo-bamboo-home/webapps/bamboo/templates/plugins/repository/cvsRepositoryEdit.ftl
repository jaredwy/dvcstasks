...
[#else]
    [@ww.hidden name='temporary.cvs.empty.quiet.period.for.job.validation' value="true" /] 
[/#if]

[@ww.textfield labelKey='repository.cvs.module' name='repository.cvs.module' required='true' /]

[@ww.select labelKey='repository.cvs.module.versionType' name='selectedVersionType'
            listKey='name' listValue='label' toggle='true'
            list=repository.versionTypes required='true' helpKey='cvs.module.version' /]

[@ui.bambooSection dependsOn='selectedVersionType' showOn='branch']
