...
<body>
    ...
    <div class="form-view">
    [@ui.bambooSection titleKey="license.existing.title" descriptionKey='license.details.description']
        [#if license??]
    ...
    [/#assign]
    [@ui.bambooSection]
        [@ww.form action="updateLicense" submitLabelKey='license.update.license' titleKey='license.update.title' description=licensePageInfo showActionErrors='false']
