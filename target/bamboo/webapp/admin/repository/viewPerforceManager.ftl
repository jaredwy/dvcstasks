...
<body>
    ...
    <div class="bambooForm">
        <div class="formFooter buttons noTopBorder">
            <a href="[@ww.url action='clearPerforceManagerCache' namespace='/admin/agent' /]">[@ww.text name='admin.repository.p4.clearCache' /]</a>
        </div>
    </div>
</body>
</html>