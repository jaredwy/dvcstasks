...
<body>
    ...
    <p class="fullyCentered"><a href="atlassian-bamboo-agent-installer-${ver.getCurrentVersion()}.jar"><img src="${req.contextPath}/images/download_remote_agent_button.png" alt="Download"/></a></p>
