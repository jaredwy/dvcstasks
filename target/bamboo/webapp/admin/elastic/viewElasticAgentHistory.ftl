...
<body>
    ...
    [#if elasticAgentDefinitions?has_content]
            ...
            <tbody>
                [#if (pager.page.list)?has_content]
                    ...
                    [#foreach agent in resultsList]
                        <tr>
                            <td><a href="${req.contextPath}/admin/agent/viewAgent.action?agentId=${agent.id}">${agent.name?html}</a></td>
                            <td><a href="${req.contextPath}/admin/elastic/image/configuration/viewElasticImageConfiguration.action?configurationId=${agent.elasticImageConfiguration.id}">${agent.elasticImageConfiguration.configurationName?html}</a></td>
                            <td>
    ...
    <div class="formFooter buttons">
        [#if elasticAgentDefinitions?has_content]
            <a class="requireConfirmation" title="[@ww.text name='elastic.history.delete.all.description' /]" href="[@ww.url action='deleteAgentHistory' namespace='/admin/elastic' /]">[@ww.text name='elastic.history.delete.all' /]</a>
        [/#if]
    </div>
</body>
</html>
...
[#macro displayOfflineOperations agent]
    ...
    | <a id="delete:${agent.id}" href="${req.contextPath}/admin/agent/removeAgent.action?agentId=${agent.id}&amp;returnUrl=/admin/elastic/viewElasticAgentHistory.action" class="requireConfirmation" title="[@ww.text name='elastic.history.delete.description' /]">[@ww.text name='elastic.history.delete' /]</a>
[/#macro]
