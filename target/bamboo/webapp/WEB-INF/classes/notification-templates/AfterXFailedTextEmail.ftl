...
[@buildNotificationTitleText build buildSummary/][#if numFailures?has_content] was successful after ${numFailures} [#if numFailures==1]failure.[#else]failures.[/#if][#else] was successful.[/#if][#lt]
[#else]
