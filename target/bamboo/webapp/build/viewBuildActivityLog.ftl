...
[@cn.logMenu action="${req.contextPath}/build/viewBuildActivityLog.action" plan=plan planType="Job" linesToDisplay=linesToDisplay secondsToRefresh=secondsToRefresh]
    <input name="buildKey" value="${plan.key}" type="hidden">
[/@cn.logMenu]
</body>
</html>